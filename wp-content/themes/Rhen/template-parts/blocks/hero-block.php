...
<section class="hero-section relative">
    <img style="z-index: -1" class=" absolute top-0 left-0 w-full h-full object-cover " src="<?php echo esc_url($hero_image); ?>" alt="Hero Image">
      <div style="z-index: -1; opacity: 50% ;" class="z-1 absolute top-0 left-0 w-full h-full bg-black opacity-[30%]"></div>          
    <div class="page-width h-full">
        <div class="flex flex-row items-center h-full">
            <div class="flex flex-col gap-4 grow w-full text-white text-center">
