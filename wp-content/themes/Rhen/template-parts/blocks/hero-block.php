...
<section class="hero-section relative flex ">
    ...
    <div class="page-width h-auto relative">
        <img class="absolute bottom-[-6rem] right-0 max-w-[120px]" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/deckia-logo.jpg">
        <div class="flex flex-row items-center h-full">
            <div class="flex flex-col gap-6 grow w-full text-white max-w-[60%]">
                <h4 class="!text-xl uppercase text-white font-bold"><?php echo esc_html($hero_subheading); ?></h4>
